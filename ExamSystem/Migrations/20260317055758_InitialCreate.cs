        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShowResultAfter = table.Column<bool>(type: "bit", nullable: false),
                    ShowCorrectAnswer = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalCorrect = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "SessionAnswerDetails",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SessionAnswerId = table.Column<int>(type: "int", nullable: false),
                    AnswerId = table.Column<int>(type: "int", nullable: false),
                    SelectedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SessionAnswerDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SessionAnswerDetails_Answers_AnswerId",
                        column: x => x.AnswerId,
                        principalTable: "Answers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SessionAnswerDetails_SessionAnswers_SessionAnswerId",
                        column: x => x.SessionAnswerId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SessionAnswerDetails_AnswerId",
                table: "SessionAnswerDetails",
                column: "AnswerId");

            migrationBuilder.CreateIndex(
                name: "IX_SessionAnswerDetails_SessionAnswerId",
                table: "SessionAnswerDetails",
                column: "SessionAnswerId");
